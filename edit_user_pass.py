...
import ui_edit_user_pass


class EditUserPass(QtWidgets.QDialog, ui_edit_user_pass.Ui_Dialog):
    def __init__(self, parent, db_conn):
        super(EditUserPass, self).__init__(parent)
    ...
    def savePass(self):
        ...
        c.execute(
            "UPDATE users SET password='{}' WHERE name='User'".
            format(
